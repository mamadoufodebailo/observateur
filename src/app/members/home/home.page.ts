...
export class HomePage implements OnInit{
  ...
  constructor(private router: Router,private apiRepository: ApiRepositoryService,
              private storage: Storage, private auth: AuthentificationService){
  }
  ...
  openPage(page:string){
    switch (page){
        case 'alerter' : this.router.navigateByUrl('/members/alerter');
          break;
        case 'informer' : this.router.navigateByUrl('/members/informer');
          break;
        case 'sensibiliser' : this.router.navigateByUrl('/members/sensibiliser');
          break;
        case 'video' : this.router.navigateByUrl('/members/video');
          break;
        default: this.router.navigateByUrl("/members/home");
          break;
    }
