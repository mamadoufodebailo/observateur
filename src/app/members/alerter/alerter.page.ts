...
export class AlerterPage implements OnInit {
  ...
  constructor(private fb: FormBuilder,private alertCtrl: AlertController,private camera: Camera,
    private apiRepository: ApiRepositoryService,private storage: Storage,
              private authService: AuthentificationService,private geolocation: Geolocation,
              private gestionRepository: GestionRepositoryService) {
  ...
  async activerPosition(){
      ...
      if (this.lattitude == null || this.longitude == null){
          this.coordonnees = "Votre position n'a pas été recupérer !";
      }else{
          this.coordonnees = "Votre position a été bien recupérer !";
      }
  }
  ...
  onAlerter(alerter){
      ...
      this.alerte.specification = alerter.specification;
      this.alerte.message = alerter.message;
      this.alerte.centre = alerter.centre;
      this.alerte.lattitude = this.lattitude;
      this.alerte.longitude = this.longitude;
      this.alerte.mobiles = this.gestionRepository.getInfoDevice();
